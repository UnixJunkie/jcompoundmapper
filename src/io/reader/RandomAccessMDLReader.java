...
public class RandomAccessMDLReader {
	...
	private int size = 0;
	private Molecule threadmol = null;
	...
	public Molecule getMol(int index) {
		...
		if (this.threadmol == null) {
			...
			try {
				mol = (Molecule) this.threadmol.clone();
	 ...
	 * @throws CDKException
	 */
	private Molecule getMolRaf(Long mr) throws IOException, CDKException {
	 ...
	 * @throws CDKException
	 */
	private Molecule getRawMolecule(String mdlString) throws CDKException {
		...
		try {
			...
			final org.openscience.cdk.interfaces.IMoleculeSet som = model.getMoleculeSet();
			final org.openscience.cdk.interfaces.IMolecule imol = som.getMolecule(0);
			mol = (Molecule) imol;
